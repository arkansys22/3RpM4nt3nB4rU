...
$route['pricelist'] = 'welcome/pricelist';
...
$route['finance-project/create_utang/(:any)'] = 'crud_finance_project/create3/$1'; // Redirect to create_crew.php
...
$route['potensial-clients-pricelist/edit/(:any)'] = 'crud_potensial_clients/edit_pricelist/$1';
...
$route['potensial-clients-pricelist/permanent_delete_gambar/(:any)/(:any)'] = 'crud_potensial_clients/permanent_delete_gambar/$1/$2'; // Hapus permanen Potensial Clients
