...
<head>
    ...
    <title>Sales Marketing Setting Target</title>
        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          <div class="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-9">
            ...
            <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
              <h1 class="text-2xl font-bold mb-4">Sales Marketing Setting Target</h1>

              <div class="col-span-12 flex flex-wrap items-center justify-between gap-3">

                <div class="relative">
                  <!-- Tombol tambah potensial clients-->
                  <a href="<?= site_url('sales-setting-target/create') ?>">
              ...
              <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="data-table-common data-table-two max-w-full overflow-x-auto">
                  <table class="table w-full table-auto" id="salesTargetTable">
                    <thead>
                      <tr>
                      <th>
