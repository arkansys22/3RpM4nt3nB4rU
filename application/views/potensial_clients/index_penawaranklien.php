...
<head>
    ...
    <title>Daftar Penawaran Ke Potensial Clients</title>
        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          <div class="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-9">
                    ...
                    <div class="swiper-slide border-r border-stroke px-10 last:border-r-0 dark:border-strokedark">
                      <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2.5">
                          <h4 class="text-xl font-bold">Penawaran Ke Klien</h4>
                        </div>
                      </div>
              ...
              <div class="hidden lg:block">
                <div class="flex flex-col items-center justify-center">
                  ...
                  <div class="text-center">
                    <h4 class="text-xl font-bold mb-2">Penawaran Ke Klien</h4>
            ...
            <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
              <h1 class="text-2xl font-bold mb-4">Daftar Penawaran Ke Potensial Klien</h1>

              <div class="col-span-12 flex flex-wrap items-center justify-center gap-3 md:justify-between">

                <div class="relative">

                  <!-- Tombol tambah penawaran potensial clients-->
                  <a href="<?= site_url('potensial-clients-penawaranklien/create') ?>">
                  ...
                  <!-- Tombol Database Harga-->
                  <a href="<?= site_url('potensial-clients-pricelist') ?>">
                ...
                <div class="relative z-20">
                  ...
                  <!-- Tombol batal penawaran potensial clients sampah-->
