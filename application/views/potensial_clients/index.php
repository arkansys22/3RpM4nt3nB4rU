              ...
              <div class="col-span-12 flex flex-wrap items-center justify-center gap-3 md:justify-between">
                ...
                <div class="relative">
                  ...
                  <a href="<?= site_url('potensial-clients-hot') ?>">
                    <button class="bg-red-500 p-3 rounded-md hover:bg-primary hover:text-white dark:hover:bg-primary  hover:bg-red-700 focus:outline-none">                      
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" stroke="currentColor" viewBox="0 0 384 512" stroke-width="2">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M414.9 161.5C340.2 29 121.1 0 121.1 0S222.2 110.4 93 197.7C11.3 252.8-21 324.4 14 402.6c26.8 59.9 83.5 84.3 144.6 93.4-29.2-55.1-6.6-122.4-4.1-129.6 57.1 86.4 165 0 110.8-93.9 71 15.4 81.6 138.6 27.1 215.5 80.5-25.3 134.1-88.9 148.8-145.6 15.5-59.3 3.7-127.9-26.3-180.9z"  fill="#FFFFFF"/>
                        </svg>                        
                    </button>
                  </a>
                  ...
                  <table class="table w-full table-auto" id="dataTableTwo">
                    ...
                    <?php $no = 1; foreach ($potensial_clients as $p): ?>
                      <tr>
                        ...
                        <td><?= tgl_indo($p->chat_date)?> <?= tgl_indo(time_ago(date('Y-m-d H:i:s', strtotime($p->chat_date)))) ?></td>
                        <td><?= $p->nomeradmin ?></td>
                        <td>
