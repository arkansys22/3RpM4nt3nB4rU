...
<head>
    ...
    <title>Recycle Bin Pricelist</title>
                ...
                <div class="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-9">
                    <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
                        <div class="flex items-center justify-between mb-4">
                          <h1 class="text-2xl font-bold">Recycle Bin Pricelist</h1>
                          <a href="<?= site_url('potensial-clients-pricelist') ?>" class="flex items-center gap-2 bg-blue-500 text-white p-3 rounded-md hover:bg-blue-700 focus:outline-none">
                    ...
                    <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        <div class="data-table-common data-table-two max-w-full overflow-x-auto">
                          ...
                          <table class="table w-full table-auto" id="dataTableTwo">
                            ...
                            <tbody>
                            <?php $no = 1; foreach ($pricelist_deleted as $p): ?>
                              <tr>
                                <td><?=$no++?></td>
                                ...
                                <td>
                                    <div class="flex flex-col items-start gap-2 w-max">
                                      ...
                                      <a href="<?= site_url('potensial-clients-pricelist/permanent_delete/'.$p->data_pricelist_idsession) ?>" class="bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600 text-center w-full whitespace-nowrap overflow-hidden text-ellipsis" onclick="return confirm('Hapus secara permanen?')">Delete Permanent</a>
                                    </div>
                                </td>
                              </tr>
