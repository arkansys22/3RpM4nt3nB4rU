          ...
          <div class="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-9">
            <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
              ...
              <form method="post" action="<?= site_url('supplies/update2/' . $supplies->id_session) ?>" class="bg-white p-6 shadow-md rounded">
                ...
                <input type="text" name="type" value="<?= $supplies->type ?>" class="w-full px-4 py-2 border rounded mb-4" required>
                ...
                <div class="flex flex-col sm:flex-row justify-end">
                  ...
                  <a href="<?= site_url('supplies/lihat/' . $supplies->id_session) ?>" class="sm:ml-2 bg-gray-500 text-white px-4 py-2 rounded w-full hover:bg-gray-600 sm:w-24 text-center">Batal</a>
                </div>
              </form>
            </div>
          </div>
