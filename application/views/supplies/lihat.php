          ...
          <div class="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-9">
            <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
                <div class="flex justify-between items-center mb-4">
                  <h1 class="text-2xl font-bold">Stock <?= $supplies->product_name ?></h1>
                    <div
                    ...
                    >
                      ...
                      <li>
                        <a
                        href="<?= site_url('supplies/edit2/' . $supplies->id_session) ?>"
                      ...
                      <li>
                        <a
                        href="<?= site_url('supplies/delete/'.$supplies->id_session) ?>"
                        class="flex px-5 py-2 font-medium hover:bg-whiter hover:text-primary dark:hover:bg-meta-4"
