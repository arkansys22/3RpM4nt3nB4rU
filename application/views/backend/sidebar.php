<!-- ===== Sidebar Start ===== -->
			      	...
			      	<div>
				        ...
				        <ul class="mb-6 flex flex-col gap-1.5">
							...
							<li>
								<a
									...
									:class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Dashboard') || (window.location.pathname === '<?= base_url('panel'); ?>' || window.location.pathname === '<?= base_url('panel/'); ?>') }"
								>
									<svg
										class="fill-current"
										width="18"
					    ...
					    <?php  if($this->session->level=='1' OR $this->session->level=='2' OR $this->session->level=='4' OR $this->session->level=='9'){ ?>
					        ...
					        <li>
					            <a
						              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
						              href="<?= base_url('potensial-clients-pricelist'); ?>"
						              @click="selected = 'potensial-clients-pricelist'"
						              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'potensial-clients-pricelist') }"
						            >
									<svg
						                class="fill-current"
						                width="18"
					       ...
					       <?php  if($this->session->level=='1' OR $this->session->level=='2' OR $this->session->level=='4'){ ?>
					        ...
					        <li>
					            <a
						              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
						              href="<?= base_url('supplies'); ?>"
						              @click="selected = 'Stock'"
    ...
    <a
        class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
        href="<?= ($this->session->level == '7') ? base_url('user/lihat/' . $this->session->id_session) : base_url('user'); ?>"
        ...
        User
					        ...
					        <li>
					            <a
						              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
						              href="<?= base_url('crews'); ?>"
						              @click="selected = 'crews'"
						              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'crews') }"
						            >
									<svg
						                class="fill-current"
						                width="18"
					        ...
					        <li>
					            <a
						              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
						              href="<?= base_url('partner'); ?>"
						              @click="selected = 'Partner'"
						              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Partner') }"
						            >
									<svg
						                class="fill-current"
						                width="18"
					        ...
					        <!-- Menu Item Partner -->
					    <?php } elseif ($this->session->level == '7') { ?>
	<li class="lg:hidden">
		<a
			class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
			href="<?= ($this->session->level == '7') ? base_url('user/lihat/' . $this->session->id_session) : base_url('user'); ?>"
...
<?php if($this->session->level=='1' OR $this->session->level=='2' OR $this->session->level=='4'){ ?>
	<li>
		<a
			class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
			href="<?= base_url('susunan-acara'); ?>"
			@click="selected = 'susunan_acara'"
			:class="{ 'bg-graydark dark:bg-meta-4': (selected === 'susunan_acara') }"
		>
			<svg
				class="fill-current"
				width="18"
