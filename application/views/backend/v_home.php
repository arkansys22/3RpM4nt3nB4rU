				...
				<div class="col-span-12">
				    <div class="flex flex-wrap justify-center gap-4">
						...
						<a href="<?= base_url('panel/staff') ?>">
							<button class="w-40 h-40 bg-fuchsia-700 text-white font-semibold rounded-none hover:bg-fuchsia-500 focus:outline-none flex flex-col items-center justify-center">
