            ...
            <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
              ...
              <!-- TAB BUTTON -->
                <div class="mb-4 flex gap-2">
                  ...
                  <button onclick="showTab('aktual')" id="tab-aktual"
                ...
                <!-- ================= TAB HUTANG ================= -->
                <div id="content-hutang" class="tab-content">
                  <div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default">
                    <div class="max-w-full overflow-x-auto">
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <?php $no = 1; foreach ($finance_hutang as $p): ?>
                          <tr>
                            ...
                            <td class="px-4 py-5">
                              <?php 
                                $kat = $this->Crud_m
                                  ->view_where('operational_kategori', ['nomer_kategori' => $p->kategori])
                                  ->row(); 
                              ?>
                ...
                <!-- ================= TAB AKTUAL ================= -->
                <div id="content-aktual" class="tab-content hidden">
                  <div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default">
                    <div class="max-w-full overflow-x-auto">
                      <table class="w-full table-auto">
                        <thead>
                        ...
                        <tbody>
                          <?php $no = 1; foreach ($finance_aktual as $p): ?>
                          <tr>
                            <td class="px-4 py-5"><?= $no++ ?></td>
                            <td class="px-4 py-5"><?= tgl_indo($p->tanggal_transaksi) ?></td>
                            <td class="px-4 py-5"><?= $p->nama_transaksi ?></td>
