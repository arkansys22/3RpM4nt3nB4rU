                ...
                <tbody>
                  ...
                  <tr class="text-center">
                    ...
                    <td class="border px-4 py-2">
                      <a href="<?= site_url('projects/edit/'.$p->id_session) ?>" class="bg-yellow-500 text-white px-2 py-1 rounded">Edit</a>
                      <a href="<?= site_url('projects/delete/'.$p->id_session) ?>" class="bg-red-500 text-white px-2 py-1 rounded" onclick="return confirm('Hapus projects ini?')">Hapus</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
