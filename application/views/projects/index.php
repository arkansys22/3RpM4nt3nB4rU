            ...
            <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
              ...
              <button class="bg-blue-500 text-white p-3 rounded-md hover:bg-blue-700 focus:outline-none">
                ...
                <button class="bg-red-500 text-white p-3 rounded-md hover:bg-red-700 focus:outline-none">
                  <a href="<?= site_url('projects/recycle_bin') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                ...
                <tbody>
                  ...
                  <tr class="text-center">
                    ...
                    <td class="border px-4 py-2">
                      <a href="<?= site_url('projects/edit/'.$p->id_session) ?>" class="bg-yellow-500 text-white px-2 py-1 rounded whitespace-nowrap mb-2 block">Edit</a>
                      <a href="<?= site_url('projects/delete/'.$p->id_session) ?>" class="bg-red-500 text-white px-2 py-1 rounded whitespace-nowrap block" onclick="return confirm('Hapus projects ini?')">Hapus</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
