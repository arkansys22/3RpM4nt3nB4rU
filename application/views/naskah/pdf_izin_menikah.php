...
<body>
    <h2 style="text-align: center;">Permohonan Izin Menikah (CPW)</h2></br>
        ...
        <p class="text-justify"><?= $client->f_bride_fathercname; ?> dan <?= $client->f_bride_mothercname; ?> yang <?= $client->f_bride_cname; ?> cintai dan hormati, <?= $client->f_bride_cname; ?> bersyukur dan berterima
    ...
    <h2 style="text-align: center;">Permohonan Izin Menikah (<?= $client->f_bride_fathercname; ?>)</h2></br>
        ...
        <p class="text-justify">Karena Insya Allah sebentar lagi <?= $client->f_bride_fathercname; ?> akan segera menikahkanmu
        dengan calon suamimu yang bernama <?= $client->m_bride_fname; ?>.</p>
        <p class="text-justify">Teriring doa, semoga Allah meridhoi hajat pernikahan yang akan <?= $client->f_bride_fathercname; ?>
