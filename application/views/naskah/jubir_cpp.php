...
<body class="bg-gray-100 p-6">
    <div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="indent text-justify">Alhamdulillah alhamdulillahi robbil ‘aalamiin, was-sholaatu wassalaamu ‘alaa asyrofil
        anbiyaa-i wal mursaliin, sayyidina muhammadin, wa’ala alihi wa’ashabihi aj’ma’iin, Amma ba’du.</p>
        <p class="indent text-justify">Shalawat serta salam marilah kita haturkan kepada junjungan Nabi Besar Muhammad
        ...
        <p class="indent text-justify">Yang kami hormati para ‘Alim ulama yang dimuliakan Allah, para sesepuh, tokoh agama,
        ...
        <p class="indent text-justify">Pertama - tama kami sekeluarga menyampaikan salam hormat kepada keluarga besar
        bapak & Ibu dengan iringan doa semoga selalu dalam lindungan dan ridho Allah SWT.</p>
        <p class="indent text-justify">Kedua, saya selaku wakil dari keluarga bermaksud mengantarkan dan menyerahkan
        ...
        <p class="indent text-justify">Menyertai keperluan proses ini kami juga menyiapkan mas kawin sesuai permintaan,
        sebagai salah satu syarat utama sebuah pernikahan.</p>
        <p class="indent text-justify">Jika berkenan menerima, kami juga membawa sedikit souvenir sebagai tanda cinta dan
        pengikat tali kekeluargaan.</p>
        <p class="indent text-justify">Namun yang utama dari barang bawaan ini adalah niat ikhlas kami, jadi kami mohon tidak
        menilai mengenai harganya.</p>
        <p class="indent text-justify">Selanjutnya, apabila sudah tiba waktunya yang dijadwalkan, kami memohon kiranya yang
        mewakili <strong>keluarga <?= $client->f_bride_fathername; ?></strong> berkenan untuk segera menikahkan mereka
        berdua.</p>
        <p class="indent text-justify">Kami sekeluarga besar senantiasa mengiringi dengan doa dan restu, semoga proses ini
        dapat berjalan lancar tanpa ada halangan suatu apapun serta dalam berkah dan ridho Allah SWT
        aamiin ya Robbal aalamiin.</p>
        <p class="indent text-justify">Saya selaku wakil keluarga yang bertindak dalam penyerahan calon pengantin pria,
        ...
        <p>Billahi taufik wal hidayah wassalamu-alaikum Wr.Wb.</p>
